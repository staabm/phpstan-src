...
class ArrayColumnTest
{
	...
	public function testImprecise5(array $array): void
	{
		...
		assertType('array<int|non-int-string, string>', array_column($array, 'nodeName', 'foo'));
		assertType('array<int|non-int-string, DOMElement>', array_column($array, null, 'foo'));
	}
	...
	public function testObjects1(array $array): void
	{
		...
		assertType('list<mixed>', array_column($array, 'foo'));
		assertType('array<string, mixed>', array_column($array, 'foo', 'tagName'));
		assertType('non-empty-array<int|non-int-string, string>', array_column($array, 'nodeName', 'foo'));
		assertType('non-empty-array<int|non-int-string, DOMElement>', array_column($array, null, 'foo'));
	}
